...
{
    public static class LanguageCatalogSeedinExtensions
    {
        ...
        public static void SeedLanguageCatalogs(this ModelBuilder modelBuilder)
        {
            var langCatalog = Create();
            
            //modelBuilder.Entity<LanguageCatalog>().HasData(langCatalog);
            //modelBuilder.Entity<LearningLanguage>().HasData(langCatalog.Items);
        }

        public static LanguageCatalog Create()
        {
